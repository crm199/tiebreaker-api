...
class Team:
    def __init__(self, name, conference, division, matchups=None, results=None):
        self.name = name
        self.conference = conference
        self.division = division

        # If no schedule is provided yet, initialize empty lists you will fill later
        self.matchups = matchups if matchups is not None else [""] * 17
        self.results = results if results is not None else ["NA"] * 17

        # Also create placeholder g1...g17 and g1result...g17result attributes
        for i in range(17):
            setattr(self, f"g{i+1}", self.matchups[i])
            setattr(self, f"g{i+1}result", self.results[i])
...
def fillSchedules(df):
    ...
    Bills.matchups = bills_schedule
    Bills.results = bills_schedule_results
    for i in range(17):
        setattr(Bills, f"g{i+1}", bills_schedule[i])
        setattr(Bills, f"g{i+1}result", bills_schedule_results[i])
    ...
    Dolphins.matchups = dolphins_schedule
    Dolphins.results = dolphins_schedule_results
    for i in range(17):
        setattr(Dolphins, f"g{i+1}", dolphins_schedule[i])
        setattr(Dolphins, f"g{i+1}result", dolphins_schedule_results[i])
    ...
    Jets.matchups = jets_schedule
    Jets.results = jets_schedule_results
    for i in range(17):
        setattr(Jets, f"g{i+1}", jets_schedule[i])
        setattr(Jets, f"g{i+1}result", jets_schedule_results[i])
    ...
    Patriots.matchups = patriots_schedule
    Patriots.results = patriots_schedule_results
    for i in range(17):
        setattr(Patriots, f"g{i+1}", patriots_schedule[i])
        setattr(Patriots, f"g{i+1}result", patriots_schedule_results[i])
    ...
    Bengals.matchups = bengals_schedule
    Bengals.results = bengals_schedule_results
    for i in range(17):
        setattr(Bengals, f"g{i+1}", bengals_schedule[i])
        setattr(Bengals, f"g{i+1}result", bengals_schedule_results[i])
    ...
    Browns.matchups = browns_schedule
    Browns.results = browns_schedule_results
    for i in range(17):
        setattr(Browns, f"g{i+1}", browns_schedule[i])
        setattr(Browns, f"g{i+1}result", browns_schedule_results[i])
    ...
    Ravens.matchups = ravens_schedule
    Ravens.results = ravens_schedule_results
    for i in range(17):
        setattr(Ravens, f"g{i+1}", ravens_schedule[i])
        setattr(Ravens, f"g{i+1}result", ravens_schedule_results[i])
    ...
    Steelers.matchups = steelers_schedule
    Steelers.results = steelers_schedule_results
    for i in range(17):
        setattr(Steelers, f"g{i+1}", steelers_schedule[i])
        setattr(Steelers, f"g{i+1}result", steelers_schedule_results[i])
    ...
    Colts.matchups = colts_schedule
    Colts.results = colts_schedule_results
    for i in range(17):
        setattr(Colts, f"g{i+1}", colts_schedule[i])
        setattr(Colts, f"g{i+1}result", colts_schedule_results[i])
    ...
    Jaguars.matchups = jaguars_schedule
    Jaguars.results = jaguars_schedule_results
    for i in range(17):
        setattr(Jaguars, f"g{i+1}", jaguars_schedule[i])
        setattr(Jaguars, f"g{i+1}result", jaguars_schedule_results[i])
    ...
    Titans.matchups = titans_schedule
    Titans.results = titans_schedule_results
    for i in range(17):
        setattr(Titans, f"g{i+1}", titans_schedule[i])
        setattr(Titans, f"g{i+1}result", titans_schedule_results[i])
    ...
    Texans.matchups = texans_schedule
    Texans.results = texans_schedule_results
    for i in range(17):
        setattr(Texans, f"g{i+1}", texans_schedule[i])
        setattr(Texans, f"g{i+1}result", texans_schedule_results[i])
    ...
    Broncos.matchups = broncos_schedule
    Broncos.results = broncos_schedule_results
    for i in range(17):
        setattr(Broncos, f"g{i+1}", broncos_schedule[i])
        setattr(Broncos, f"g{i+1}result", broncos_schedule_results[i])
    ...
    Chiefs.matchups = chiefs_schedule
    Chiefs.results = chiefs_schedule_results
    for i in range(17):
        setattr(Chiefs, f"g{i+1}", chiefs_schedule[i])
        setattr(Chiefs, f"g{i+1}result", chiefs_schedule_results[i])
    ...
    Chargers.matchups = chargers_schedule
    Chargers.results = chargers_schedule_results
    for i in range(17):
        setattr(Chargers, f"g{i+1}", chargers_schedule[i])
        setattr(Chargers, f"g{i+1}result", chargers_schedule_results[i])
    ...
    Raiders.matchups = raiders_schedule
    Raiders.results = raiders_schedule_results
    for i in range(17):
        setattr(Raiders, f"g{i+1}", raiders_schedule[i])
        setattr(Raiders, f"g{i+1}result", raiders_schedule_results[i])
    ...
    Commanders.matchups = commanders_schedule
    Commanders.results = commanders_schedule_results
    for i in range(17):
        setattr(Commanders, f"g{i+1}", commanders_schedule[i])
        setattr(Commanders, f"g{i+1}result", commanders_schedule_results[i])
    ...
    Cowboys.matchups = cowboys_schedule
    Cowboys.results = cowboys_schedule_results
    for i in range(17):
        setattr(Cowboys, f"g{i+1}", cowboys_schedule[i])
        setattr(Cowboys, f"g{i+1}result", cowboys_schedule_results[i])
    ...
    Giants.matchups = giants_schedule
    Giants.results = giants_schedule_results
    for i in range(17):
        setattr(Giants, f"g{i+1}", giants_schedule[i])
        setattr(Giants, f"g{i+1}result", giants_schedule_results[i])
    ...
    Eagles.matchups = eagles_schedule
    Eagles.results = eagles_schedule_results
    for i in range(17):
        setattr(Eagles, f"g{i+1}", eagles_schedule[i])
        setattr(Eagles, f"g{i+1}result", eagles_schedule_results[i])
    ...
    Bears.matchups = bears_schedule
    Bears.results = bears_schedule_results
    for i in range(17):
        setattr(Bears, f"g{i+1}", bears_schedule[i])
        setattr(Bears, f"g{i+1}result", bears_schedule_results[i])
    ...
    Lions.matchups = lions_schedule
    Lions.results = lions_schedule_results
    for i in range(17):
        setattr(Lions, f"g{i+1}", lions_schedule[i])
        setattr(Lions, f"g{i+1}result", lions_schedule_results[i])
    ...
    Packers.matchups = packers_schedule
    Packers.results = packers_schedule_results
    for i in range(17):
        setattr(Packers, f"g{i+1}", packers_schedule[i])
        setattr(Packers, f"g{i+1}result", packers_schedule_results[i])
    ...
    Vikings.matchups = vikings_schedule
    Vikings.results = vikings_schedule_results
    for i in range(17):
        setattr(Vikings, f"g{i+1}", vikings_schedule[i])
        setattr(Vikings, f"g{i+1}result", vikings_schedule_results[i])
    ...
    Buccaneers.matchups = buccaneers_schedule
    Buccaneers.results = buccaneers_schedule_results
    for i in range(17):
        setattr(Buccaneers, f"g{i+1}", buccaneers_schedule[i])
        setattr(Buccaneers, f"g{i+1}result", buccaneers_schedule_results[i])
    ...
    Falcons.matchups = falcons_schedule
    Falcons.results = falcons_schedule_results
    for i in range(17):
        setattr(Falcons, f"g{i+1}", falcons_schedule[i])
        setattr(Falcons, f"g{i+1}result", falcons_schedule_results[i])
    ...
    Saints.matchups = saints_schedule
    Saints.results = saints_schedule_results
    for i in range(17):
        setattr(Saints, f"g{i+1}", saints_schedule[i])
        setattr(Saints, f"g{i+1}result", saints_schedule_results[i])
    ...
    Panthers.matchups = panthers_schedule
    Panthers.results = panthers_schedule_results
    for i in range(17):
        setattr(Panthers, f"g{i+1}", panthers_schedule[i])
        setattr(Panthers, f"g{i+1}result", panthers_schedule_results[i])
    ...
    Niners.matchups = niners_schedule
    Niners.results = niners_schedule_results
    for i in range(17):
        setattr(Niners, f"g{i+1}", niners_schedule[i])
        setattr(Niners, f"g{i+1}result", niners_schedule_results[i])
    ...
    Cardinals.matchups = cardinals_schedule
    Cardinals.results = cardinals_schedule_results
    for i in range(17):
        setattr(Cardinals, f"g{i+1}", cardinals_schedule[i])
        setattr(Cardinals, f"g{i+1}result", cardinals_schedule_results[i])
    ...
    Rams.matchups = rams_schedule
    Rams.results = rams_schedule_results
    for i in range(17):
        setattr(Rams, f"g{i+1}", rams_schedule[i])
        setattr(Rams, f"g{i+1}result", rams_schedule_results[i])
    ...
    Seahawks.matchups = seahawks_schedule
    Seahawks.results = seahawks_schedule_results
    for i in range(17):
        setattr(Seahawks, f"g{i+1}", seahawks_schedule[i])
        setattr(Seahawks, f"g{i+1}result", seahawks_schedule_results[i])
